...
(function (factory) {
    ...
    var template$1 = "<div class=\"layer\"></div>";
    ...
    var template$2 = "<div class=\"layers\"></div>";
    ...
    var template$3 = "<div class=\"group\">\r\n\r\n    <!-- Label -->\r\n    <span class=\"label\">{{ label }}</span>\r\n\r\n    <!-- Content -->\r\n    <div class=\"content\"></div>\r\n\r\n</div>";
    ...
    class Group extends HTMLElement {
        constructor({ label }) {
            ...
            this._element = this._addTemplate(template$3, label);
    ...
    class Layout {
        ...
        createGroup(label, options) {
            ...
            if (options.container) {
                container = this._layers.get(options.container);
            }
    ...
    class Components {
        ...
        create(object, property, options) {
            ...
            const container = this._layout.getContainer(options.container);
    ...
    class Component extends HTMLElement {
         ...
         */
        get container() {
            return this.__options.container;
        }
    ...
    class Slider$1 extends Component {
        constructor({ object, property, options }) {
            super({ style: style$4, template: template$4, object, property, options });
    ...
    window.customElements.define('dddd-slider', Slider$1);
    ...
    class Text$1 extends Component {
        constructor({ object, property, options }) {
            super({ style: style$5, template: template$5, object, property, options });
    ...
    window.customElements.define('dddd-input', Text$1);
    ...
    class Image$1 extends Component {
        constructor({ object, property, options }) {
            super({ style: style$6, template: template$6, object, property, options });
    ...
    window.customElements.define('dddd-image', Image$1);
    ...
    class Dropdown$1 extends Component {
        constructor({ object, property, options }) {
            super({ style: style$7, template: template$7, object, property, options });
    ...
    window.customElements.define('dddd-dropdown', Dropdown$1);
    ...
    class Checkbox$1 extends Component {
        constructor({ object, property, options }) {
            super({ style: style$8, template: template$8, object, property, options });
    ...
    window.customElements.define('dddd-checkbox', Checkbox$1);
    ...
    class Button extends Component {
        constructor({ options }) {
            super({ style: style$9, template: template$9, options });
    ...
    class Color$1 extends Component {
        constructor({ object, property, options }) {
            super({ style: style$a, template: template$a, object, property, options });
    ...
    class MultiInput$1 extends Component {
        constructor({ object, property, options }) {
            super({ style: style$b, template: template$b, object, property, options });
            ...
            // Options
            this._stepSize = options.stepSize || DEFAULT_STEP_SIZE;
        ...
        _createInputs() {
            for (const key in this._value) {
                ...
                input.value = this._value[key];
                this.$refs.inputContainer.appendChild(input);
            }
        }

        _updateValue(movementX) {
        ...
        _mouseMoveHandler(e) {
            if (this._isPointerLockActive) {
                this._updateValue(e.movementX);
            }
        }
    }

    window.customElements.define('dddd-multi-input', MultiInput$1);
    ...
    class DDDD {
        ...
        add(object, property, options) {
            return this._components.create(object, property, options);
        }
    ...
    DDDD.Text = Text$1;
    DDDD.Slider = Slider$1;
    DDDD.Image = Image$1;
    DDDD.Dropdown = Dropdown$1;
    DDDD.Checkbox = Checkbox$1;
    DDDD.Button = Button;
    DDDD.Color = Color$1;
    DDDD.MultiInput = MultiInput$1;
    ...
    dddd.createGroup('Shape #3', {
        container: 'Layer #1'
    });

    dddd.createGroup('Shape #4', {
        container: 'Layer #1'
    });

    dddd.createGroup('Shape #5', {
        container: 'Layer #1'
    });

    // const group = dddd.createGroup('Shape #2');

    const position = dddd.add(settings, 'position', {
        container: 'Shape #2',
        type: MultiInput,
        stepSize: 0.01
    });
